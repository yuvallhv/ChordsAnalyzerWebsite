...
<React.Fragment>
  ...
  <p>
    ...
    This required us to use (and learn) different web technologies such as HTML, CSS and Express.<br/>
  ...
  <ul>
    ...
    <li><span class="li-header">Results visualization</span> - HTML, CSS, Node.js, Express</li>
  </ul>
  <br/>
